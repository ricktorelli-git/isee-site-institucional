          ...
          <span className="mb-4 inline-block text-primary font-semibold text-sm uppercase tracking-wider">
            A base que sustenta a Iseecodes
                    ...
                    <p className="text-lg leading-relaxed text-muted-foreground">
                        A Iseecodes nasce de uma trajetória sólida em gestão, finanças, controladoria e governança.
                        A proposta é levar essa vivência para soluções úteis e conectadas à realidade das empresas.
                    </p>
                        ...
                        <div className={cn(inView && "animate-in fade-in slide-in-from-right-8 duration-700 delay-150")}>
                            ...
                            <blockquote className="relative mb-8">
                                ...
                                <p className="pl-8 text-lg leading-relaxed text-muted-foreground italic">
                                    &ldquo;Ao longo da minha trajetória em gestão, controladoria e finanças, sempre considerei a tecnologia um aliado importante para agilizar a operação, ampliar o controle e apoiar a tomada de decisão.&rdquo;
                                </p>
                            </blockquote>
                            ...
                            <div className="mb-8 rounded-lg border border-accent/20 bg-accent/10 p-5">
                                ...
                                <p className="mt-2 text-sm text-muted-foreground">
                                    A empresa inicia sua atuação com seriedade, clareza de propósito e foco em soluções úteis,
                                    consistentes e alinhadas à realidade de cada cliente.
                                </p>
                            </div>
                            ...
                            <div className="flex items-start gap-3 rounded-xl border border-accent/20 bg-accent/10 p-4">
                                ...
                                <div>
                                    <div className="font-semibold text-foreground">Vivência prática em tecnologia aplicada</div>
                                    <div className="text-sm text-muted-foreground">
                                        Além da atuação em gestão, finanças, controladoria e governança, houve participação direta no
                                        desenvolvimento, implantação e reestruturação de sistemas voltados a necessidades reais de controle,
                    ...
                    >
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-xs text-muted-foreground">
                                    Vivência em gestão de recursos, equilíbrio financeiro e continuidade.
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-xs text-muted-foreground">
                                    Repertório em controle, governança e apoio à decisão com base em informação confiável.
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-xs text-muted-foreground">
                                    Uso da contabilidade como apoio à leitura e à tomada de decisão.
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-xs text-muted-foreground">
                                    Leitura crítica de estruturas corporativas e processos decisórios de longo prazo.
                                </div>
                            </div>
                        </div>
                    </div>
