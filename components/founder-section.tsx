          ...
          <span className="mb-4 inline-block text-primary font-semibold text-sm uppercase tracking-wider">
            A base que sustenta a Iseecodes
                    ...
                    <p className="text-lg leading-relaxed text-muted-foreground">
                        A Iseecodes nasce de uma trajetória sólida em gestão, controladoria, finanças e governança. Mais
                        do que
              ...
              <span className="relative z-10 flex items-center">
                ...
                <div className="mx-auto mb-18 max-w-6xl">
                    <div className="grid items-start gap-12 lg:grid-cols-2 lg:gap-16">
                        <div
                            className={cn("relative", inView && "animate-in fade-in slide-in-from-left-8 duration-700")}>
                            <div className="relative">
                                <figure className="relative overflow-hidden rounded-2xl shadow-2xl">
                                    ...
                                    <figcaption className="absolute right-0 bottom-0 left-0 p-6">
                                        <span className="block text-2xl font-bold text-white">Ricardo Costa Tortorelli</span>
                                ...
                                <div
                                    className="absolute -right-4 -bottom-4 -z-10 h-full w-full rounded-2xl bg-primary/15"
                                    aria-hidden="true"/>
                            </div>
                        </div>

                        <div
                            className={cn(inView && "animate-in fade-in slide-in-from-right-8 duration-700 delay-150")}>
                            <div
                                className="mb-8 flex items-start gap-3 rounded-xl border-l-4 border-primary bg-muted/50 p-4">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-muted-foreground">
                                        <span className="font-medium text-foreground">Contador</span> pela <span
                                        className="font-medium text-foreground">PUC-RS</span> e pós-graduado em <span
                                        className="font-medium text-foreground">Finanças Empresariais</span> pela <span
                                        className="font-medium text-foreground">FGV</span>.
                                    </div>
                                </div>
                            </div>
                            ...
                            <blockquote className="relative mb-8">
                                ...
                                <p className="pl-8 text-lg leading-relaxed text-muted-foreground italic">
                                    ...
                                    tecnologia só faz
                                    sentido quando responde a necessidades reais da operação, do controle e da decisão.
                                    A Iseecodes
                            ...
                            <div className="mb-8 rounded-lg border border-accent/20 bg-accent/10 p-5">
                                <p className="font-semibold text-foreground">✓ A Iseecodes nasce nova, mas não nasce do
                                    zero.</p>
                                <p className="mt-2 text-sm text-muted-foreground">
                                    A empresa inicia sua atuação com seriedade, clareza de propósito e compromisso com
                                    utilidade prática.
                                    O objetivo não é prometer mais do que pode entregar, mas construir soluções
                                    consistentes, úteis e
                            ...
                            <div className="flex items-start gap-3 rounded-xl border border-accent/20 bg-accent/10 p-4">
                                ...
                                <div>
                                    <div className="font-semibold text-foreground">Vivência prática em tecnologia
                                        aplicada
                                    </div>
                                    <div className="text-sm text-muted-foreground">
                                        Ao longo da trajetória profissional, além da atuação em gestão, finanças,
                                        controladoria e governança,
                                        também houve participação direta no desenvolvimento, implantação e
                                        reestruturação de sistemas criados
                                        para responder a necessidades reais de controle, operação e informação. Essa
                                        vivência reforça uma visão
                                        de tecnologia conectada à realidade do negócio.
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="mx-auto max-w-6xl">
                    <div className="grid grid-cols-2 gap-4 md:grid-cols-4" role="list"
                        ...
                        >
                            ...
                            <div>
                                <div className="text-sm font-semibold text-foreground">Gestão financeira e
                                    sustentabilidade
                                </div>
                                <div className="mt-1 text-xs text-muted-foreground">Vivência prática em gestão de
                                    recursos, equilíbrio financeiro e visão de continuidade.
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-xs text-muted-foreground">Repertório em mecanismos de
                                    controle, governança e apoio à tomada de decisão com base em informação confiável.
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="mt-1 text-xs text-muted-foreground">Uso da contabilidade como
                                    instrumento de leitura, direcionamento e suporte à tomada de decisão.
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            <div>
                                <div className="text-sm font-semibold text-foreground">Leitura estratégica e
                                    conformidade
                                </div>
                                <div className="mt-1 text-xs text-muted-foreground">Experiência em conselho fiscal, com
                                    leitura crítica de estruturas corporativas e de processos decisórios de longo prazo.
                                </div>
                            </div>
                        </div>
                    </div>
